...
describe('<ActiveOrderInfo />', () => {
    ...
    it('should show the expanded view of payment method details after clicking on a payment method and hide it after clicking on it again', async () => {
        render(<ActiveOrderInfo />);

        const alipayMethod = screen.getByText('Alipay');
        await userEvent.click(alipayMethod);
    ...
    it('should show the expanded view of payment method details after clicking on expand all and hide it after clicking the button again', async () => {
